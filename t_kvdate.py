...
def file_teardown(startfilename="t_kvdate_tst", ext_range=4):
    logger.info(
        "removing files from startfilename:%s:ext_range:%d", startfilename, ext_range
    )
...
def file_setup(startfilename="t_kvdate_tst", ext_range=4):
    logger.info(
        "creating files from startfilename:%s:ext_range:%d", startfilename, ext_range
    )
    for fname in generate_test_filenames(startfilename, ext_range):
...
class TestKvdateFilenames(unittest.TestCase):
    ...
    def test_datetime_from_str_p01_zero_padded(self):
        self.assertEqual(
            kvdate.datetime_from_str("01/01/19"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("01/01/2019"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("01-01-19"), datetime.datetime(2019, 1, 1)
        )
        ...
        self.assertEqual(
            kvdate.datetime_from_str("2019-01-01"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("20190101"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("01-Jan-2019"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("01-Jan-19"), datetime.datetime(2019, 1, 1)
        )

    def test_datetime_from_str_p02_notzero_padded(self):
        self.assertEqual(
            kvdate.datetime_from_str("1/1/19"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("1/1/2019"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("1-1-19"), datetime.datetime(2019, 1, 1)
        )
        ...
        self.assertEqual(
            kvdate.datetime_from_str("1-Jan-2019"), datetime.datetime(2019, 1, 1)
        )
        self.assertEqual(
            kvdate.datetime_from_str("1-Jan-19"), datetime.datetime(2019, 1, 1)
        )
    ...
    def test_datetime_from_str_p04_match_ts_maintain(self):
        self.assertEqual(
            kvdate.datetime_from_str("2021-12-31"), datetime.datetime(2021, 12, 31)
        )
        self.assertEqual(
            kvdate.datetime_from_str("2021-12-31 00:00:00"),
            datetime.datetime(2021, 12, 31),
        )
        self.assertEqual(
            kvdate.datetime_from_str("12/31/2021"), datetime.datetime(2021, 12, 31)
        )
        self.assertEqual(
            kvdate.datetime_from_str("2021-12-31T00:00:00Z"),
            datetime.datetime(2021, 12, 31),
        )
        self.assertEqual(
            kvdate.datetime_from_str("31-Dec-2021 00:00"),
            datetime.datetime(2021, 12, 31, 0, 0),
        )
        self.assertEqual(
            kvdate.datetime_from_str("31-Dec-2021 01:01"),
            datetime.datetime(2021, 12, 31, 1, 1),
        )
        self.assertEqual(
            kvdate.datetime_from_str("31-Dec-21 00:00"),
            datetime.datetime(2021, 12, 31, 0, 0),
        )
        self.assertEqual(
            kvdate.datetime_from_str("31-Dec-21 01:01"),
            datetime.datetime(2021, 12, 31, 1, 1),
        )

    def test_datetime_from_str_p05_date_and_time(self):
        self.assertEqual(
            kvdate.datetime_from_str("12/10/2025  11:31:00 PM"),
            datetime.datetime(2025, 12, 10, 23, 31),
        )
        self.assertEqual(
            kvdate.datetime_from_str("12/10/2025  11:31:00 AM"),
            datetime.datetime(2025, 12, 10, 11, 31),
        )
        self.assertEqual(
            kvdate.datetime_from_str("03/03/2025  11:31"),
            datetime.datetime(2025, 3, 3, 11, 31),
        )
        self.assertEqual(
            kvdate.datetime_from_str("3/3/2025  11:31"),
            datetime.datetime(2025, 3, 3, 11, 31),
        )
        self.assertEqual(
            kvdate.datetime_from_str("3/3/2025  1:1"),
            datetime.datetime(2025, 3, 3, 1, 1),
        )
    ...
    def test_datetime_from_str_p06_pass_datetime(self):
        self.assertEqual(
            kvdate.datetime_from_str(datetime.datetime(2025, 12, 10, 23, 31)),
            datetime.datetime(2025, 12, 10, 23, 31),
        )
        # self.assertEqual(kvdate.datetime_from_str('12/10/2025 11:31:00 AM'), datetime.datetime(2025, 12, 10, 11, 31))
    ...
    def test_datetimezone_from_str_p01_zero_padded_no_colon_neg_TZ(self):
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01 01:01:01.0101-0700"),
            datetime.datetime(
                2019,
                1,
                1,
        ...
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01 01:01:01-0700"),
            datetime.datetime(
                2019,
                1,
                1,
        ...
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01T01:01:01.0101-0700"),
            datetime.datetime(
                2019,
                1,
                1,
        ...
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01T01:01:01-0700"),
            datetime.datetime(
                2019,
                1,
                1,
    ...
    def test_datetimezone_from_str_p02_zero_padded_colon_neg_TZ(self):
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01 01:01:01.0101-07:00"),
            datetime.datetime(
                2019,
                1,
                1,
        ...
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01 01:01:01-07:00"),
            datetime.datetime(
                2019,
                1,
                1,
        ...
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01T01:01:01.0101-07:00"),
            datetime.datetime(
                2019,
                1,
                1,
        ...
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01T01:01:01-07:00"),
            datetime.datetime(
                2019,
                1,
                1,
    ...
    def test_datetimezone_from_str_p03_zero_padded_no_colon_pos_TZ(self):
        self.assertEqual(
            ...
            datetime.datetime(
                ...
                1,
                10100,
                tzinfo=datetime.timezone(datetime.timedelta(0, 25200)),
            ),
        )
        self.assertEqual(
            kvdate.datetimezone_from_str("2019-01-01 01:01:01+0700"),
