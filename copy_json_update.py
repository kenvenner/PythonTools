...
excel_dir = (
    "/Users/KenVenner/OneDrive - Hermeus Corp/Documents/2024-10-08-NetSuite-Mgmt/"
)
...
excel_full_filename = kvutil.filename_maxmin(
    excel_dir + excel_filename_glob, reverse=True
)
