...
class TestKVMatch(unittest.TestCase):
    ...
    def test_badoption_msg_p01_pass(self):
        self.assertEqual(
            kvmatch.badoption_msg("test_badoption_msg_p01_pass", "val", "val2"),
            "test_badoption_msg_p01_pass:possible mistyped optiondict key [val] could be [val2]",
        )

    def test_badoption_msg_p02_fixed_pass(self):
        self.assertEqual(
            kvmatch.badoption_msg(
                "test_badoption_msg_p02_fixed_pass", "val", "val2", fixed=True
            ),
            "test_badoption_msg_p02_fixed_pass:possible mistyped optiondict key [val] could be [val2] - this was fixed",
        )

    def test_badoption_msg_p03_not_fixed_pass(self):
        self.assertEqual(
            kvmatch.badoption_msg(
                "test_badoption_msg_p03_not_fixed_pass",
                "val",
                "val2",
                fixed=False,
            ),
            "test_badoption_msg_p03_not_fixed_pass:possible mistyped optiondict key [val] could be [val2] - this was NOT fixed",
        )

    # the function name:
    def test_badoptiondict_check_p01_bad_key(self):
        optiondict = {"no_case": True}
        result = kvmatch.badoptiondict_check(
            "test_badoptiondict_check_p01_bad_key",
            optiondict,
            badoptiondict,
            True,
        )
    ...
    def test_badoptiondict_check_p02_bad_key_fixed(self):
        optiondict = {"no_case": True}
        result = kvmatch.badoptiondict_check(
            "test_badoptiondict_check_p02_bad_key",
            optiondict,
            badoptiondict,
            True,
            fix_missing=True,
    ...
    def test_badoptiondict_check_p03_bad_key_not_fixed(self):
        ...
        result = kvmatch.badoptiondict_check(
            "test_badoptiondict_check_p03_bad_not_fixed_key",
            optiondict,
            badoptiondict,
            True,
            fix_missing=True,
        ...
        self.assertEqual(
            result[0],
            "test_badoptiondict_check_p03_bad_not_fixed_key:possible mistyped optiondict key [no_case] could be [nocase] - this was NOT fixed",
        )
        self.assertTrue("nocase" in optiondict)
    ...
    def test_MatchRow___init___p01_init_optiondict_warning(self):
        self.assertIsInstance(
            kvmatch.MatchRow(
                ["Col1"], optiondict={"no_case": True, "no_warnings": True}
            ),
            kvmatch.MatchRow,
        )
    ...
    def test_MatchRow___init___p02_init_optiondict_warning_returned_value(self):
        ...
        self.assertEqual(
            p.warning_msg[0],
            kvmatch.badoption_msg(
                "kvmatch:MatchRow:__init__", "no_case", badoptiondict["no_case"]
            ),
        )

    def test_MatchRow___init___p03_init_optiondict_warning_invalid_optiondict_no_die(
        self,
    ):
    ...
    def test_MatchRow___init___f01_init_optiondict_warning_invalid_optiondict_die_no_fix(
        self,
    ):
        tempdict = dict(badoptiondict)
        tempdict["no_warnings"] = True
    ...
    def test_MatchRow___init___p01_init_optiondict_unique_column(self):
        p = kvmatch.MatchRow(
            ["Col1"], optiondict={"unique_column": True, "no_warnings": True}
        )
    ...
    def test_MatchRow___init___p01_init_optiondict_dieonbadoption(self):
        p = kvmatch.MatchRow(
            ["Col1"], optiondict={"dieonbadoption": True, "no_warnings": True}
        )
